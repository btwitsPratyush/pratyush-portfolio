  ...
  return (
    <section id="about" className="section">
      <div className="container mx-auto px-4 py-20">
        ...
        >
          <motion.h2 variants={itemVariants} className="text-4xl md:text-5xl font-bold mb-8 text-center text-gradient">
            About Me
          </motion.h2>

          <motion.div variants={itemVariants} className="card-gradient rounded-2xl p-6 md:p-8 shadow-xl">
